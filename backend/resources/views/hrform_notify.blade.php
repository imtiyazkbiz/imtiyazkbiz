                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                     ...
                                     <p style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 23px;margin-left: 4px;">
                                     Your company, {{$company_name}}, has requested that you download and complete the form below.</p>
                                       
                                     <p style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 23px;margin-left: 4px;">
                                         <a target="_blank"  style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;" href="{{env('APP_URL').'/hr-forms/'.$file}}"><b>{{ucfirst($file_name)}}</b></a>
                                    </br></p>
                                        <p style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 23px;margin-left: 4px;">
                                        Once you complete the form and save it to your computer, please login to your account and click the “Documents” link.  Select the “Company Form” tab and click the upload action icon next to the name of the document listed above to submit the completed document to your company.  Please email us at <a target="_blank"
                                                                            style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;"          href="mailto: {{ env('MAIL_SUPPORT') }}">
                                                                                                        {{ env('MAIL_SUPPORT') }}
