                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Below is the login information you requested from
                                            <span
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 1.5em; font-weight: 500;">
                                            ...
                                            <table
                                                ...
                                                <tbody
                                                    ...
                                                    <tr style="text-align: center; background: #f7ffee;">
                                                        <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; text-align: right; font-weight: 600; text-align: left; width: 15%;">
                                                            Username
                                                        </td>
                                                        <td
                                        ...
                                        <p
                                            style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 1.5em; margin: 20px 4px 20px 4px; text-align: left;">
                                            Please <a
                                                style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;"
                                                href="{{ env('LMS_URL') . '/#/login' }}">click here</a> to
                                            login.
                                        </p>
