                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        @foreach ($courses as $course)
                                            <p
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left; font-weight: 600; text-transform: uppercase;">
                                                {{ ucwords($course) }}
                                        ...
                                        <p
                                            ...
                                            To complete your course(s), <a href="{{ env('LMS_URL') . '/#/login' }}"
                                                style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;">click
                                                here</a> to login to your account.
                                            ...
                                            please <a
                                                ...
                                                href="{{ env('LMS_URL') . '/#/forget_password' }}">click here</a> and
