                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Welcome to {{ env('SITE_NAME') }}! Your online training account is now
                                            active and can be accessed from any device connected to the internet
                                        ...
                                        <ul
                                            ...
                                            <li style="margin-bottom: 10px;">Watch our <span
                                                ...
                                                (located in the
                                                left-side menu bar) that gives you step-by-step instructions
                                                on taking your assigned online training courses, accessing
                                                your certificates, and much more.</li>
