                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <div class="table"
                                        ...
                                        <table
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; margin: 8px auto; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                            <tbody
                                            ...
                                            @else
                                                <tr style="text-align: center; background: #f7ffee;">
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; border-top: 1px solid #efefef; text-align: right; font-weight: 600; text-align: left;">
                                                        First Name
                                                    </td>
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; border-top: 1px solid #efefef; text-align: right;">
                                                        {{ $first_name }}
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="table"
                                             style="font-family: Helvetica, sans-serif; box-sizing: border-box; margin-top: 20px; margin-bottom: 20px;">
                                            <table
                                        ...
                                        <table
                                            ...
                                            @if ($interface != 'Company')
                                                <tr style="text-align: center; background: #f7ffee;">
                                                    ...
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; text-align: right; font-weight: 600;">
                                                        (Credit Card)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; text-align: right;">
                                                        @if(strlen($credit_card) > 4){{ $credit_card }}
                                                        @else
                                                            ************{{ $credit_card }}
                                                        @endif
                                                    </td>
                                            ...
                                            @endif
                                            @if($promo_code)
                                                <tr style="text-align: right; background: #f7ffee;">
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; text-align: left; font-weight: 600;">
                                                        Promotional Code
                                                    </td>
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef;">
                                                        {{ $promo_code }}
                                                    </td>
                                                </tr>
                                                <tr style="text-align: right; background: #f7ffee;">
                                            ...
                                            @if ($interface == 'Company')
                                                <tr style="text-align: right; background: #f7ffee;">
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef; text-align: left; font-weight: 600;">
                                                        {{ ucfirst($plan_detail) }} Charge
                                                    </td>
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 20px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef;">
                                                        ${{ $fee }}
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($interface == 'Company')
                                                <tr style="text-align: right;">
                                                    ...
                                                    <td
                                                            style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 16px; line-height: 10px; padding: 12px 10px; border-bottom: 1px solid #efefef;">
                                                        {{ $street_address }}
                                                    </td>
                                                </tr>
                                                <tr style="text-align: right; background: #f7ffee;">
