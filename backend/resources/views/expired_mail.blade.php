                                    ...
                                    <td class="content-cell"
                                        ...
                                        @if ($company_name == 'individual')
                                            <p
                                                ...
                                                You have selected to view the following course(s):
                                            </p>
                                        @else
                                            <p
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                This notification is to advise you that the following
                                                {{ env('SITE_NAME') }}
                                                courses
                                                assigned to you by
                                        ...
                                        @foreach ($courses as $course)
                                            <p
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left; text-transform: uppercase; font-weight: 600;">
                                        ...
                                        <p
                                            ...
                                            However, you can still take the course(s). Please <a
                                                href="{{ env('LMS_URL') . '/#/login' }}"
                                                style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;">click
                                                here</a> to login to your account and take the course(s) immediately.
                                            ...
                                            @if ($company_name == 'individual')
                                                ...
                                                Please email us at <a
                                                    style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;"
                                                    target="_blank" href="mailto: {{ env('MAIL_SUPPORT') }}">
                                                    {{ env('MAIL_SUPPORT') }}
