                        ...
                        <td style="background-size:100% 100%; background: url(images/certificate-bg.jpg) no-repeat top; padding: 45px;"
                            ...
                            <table cellpadding="0" cellspacing="0" style="width:100%">
                                ...
                                <tr>
                                    <td>
                                        <table
                                            style="text-align: center; width: 90%; margin: auto; padding: 90px 0 5px 0;"
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td style="width: 30%; text-align: left;">
                                                    ...
                                                    <pre
                                                        style="color: #01154F;margin: 0;font-size: 11px;font-family: 'Montserrat', sans-serif;font-weight: 600;width:200px;letter-spacing: 1px; padding-top: 7px;">{{ ucfirst($signature_title_2) }}</pre>
