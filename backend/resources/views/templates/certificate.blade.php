                        ...
                        <table style="width:100%; position:relative; padding:10px; border-spacing: 15px;">
                            ...
                            <tr>
                                <td colspan="3" class="certi-issued" style="text-align:center;">
                                    <h2
                                        style="font-family: 'Times New Roman', Times, serif; font-size: 16px; color: #0f0f0f; margin: 0 0 26px 0;">
                                        For successfully completing the {{ $title }}</h2>
                                </td>
                            </tr>

                            <tr class="certi-date-section">
                                <td style="padding: 0!important;">
                                    <span style="font-size: 13px; color: #0f0f0f; font-weight: 600;">Completion Date:
                                    </span>
                                    <label
                                        style="font-size: 11px; color: #0f0f0f; font-weight: normal;">{{ $completion_date }}</label>
                                </td>
                                <td>

                                </td>
                                <td style="text-align:right;">
                                    <span style="font-size: 13px; color: #0f0f0f; font-weight: 600;">Expiration Date:
                                    </span>
                                    <label
                                        style="font-size: 11px; color: #0f0f0f; font-weight: normal;">{{ $expiration_date }}</label>
                                </td>
                            </tr>
                            <tr>
