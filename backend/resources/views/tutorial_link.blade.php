                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                     ...
                                     Please watch the following tutorial to learn how to navigate your {{ env('SITE_NAME') }} account. <a target="_blank" href="{{$tutorial_link}}" style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;margin-top:2px;"
                                                >{{$tutorial_link}}</a></p>
                                                
                                                <p style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 23px;margin-left: 4px;">       
                                                
                                                Please email us at <a target="_blank"
                                                ...
                                                <a
                                                                ...
                                                                here</a> to login into your account to begin your training.</p>
