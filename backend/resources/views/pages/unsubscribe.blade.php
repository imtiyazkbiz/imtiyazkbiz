<html>
<head>
    <title>{{ env('SITE_NAME') }} | Unsubscribed Successfully</title>
    ...
    <style>
        body {
            ...
            padding: 0;
            background: #543093;
            background: -moz-linear-gradient(45deg, #447307 32%, #99CB58 100%);
            background: -webkit-linear-gradient(45deg, #447307 32%, #99CB58 100%);
            background: linear-gradient(45deg, #447307 32%, #99CB58 100%);
            filter: progid:DXImageTransform.Microsoft.gradient(
                    startColorstr="#447307",
                    endColorstr="#99CB58",
                    GradientType=1
            );
        }
...
<div class="container">
    <div class="inner-container">
                    ...
                    <g id="face">
                        ...
                        <g id="eye-group">
                            <g id="eyes" class="eyes">
                                ...
                                <ellipse id="eye-left" cx="235.5" cy="172.8" rx="11.2" ry="13.8" fill="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                                <path id="eyebrow-sad-right" d="M341.9,133.7c2.6,5.3,14.8,14.1,24.3,14.7" fill="none" stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
        ...
        <div class="bottom">
            <h2 class="title">You have been unsubscribed sucessfully!</h2>
            <p class="subtitle">You will no longer receive any email from our platfrom</p>
            <p class="subtitle text-muted">Click here to email at <a href="mailto:{{ env('MAIL_SUPPORT') }}">{{ env('MAIL_SUPPORT') }}</a>, if this was done in error</p>
        </div>
    </div>
</div>
</body>
