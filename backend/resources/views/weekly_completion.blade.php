                    ...
                    <tr>
                        <td  width="100%"  cellpadding="0" cellspacing="0"
                            style="font-family: Helvetica, sans-serif; background:white; box-sizing: border-box; padding: 20px; ">
                               ...
                               <img src="https://api.homeoftraining.com/images/logo.jpg" style="text-align: left;width: 20%;">
							   
							   
                           
                        </td>
						   <!-- <td  width="0%" cellpadding="0" cellspacing="0"  -->
                            <!-- style="font-family: Helvetica, sans-serif; background:white; box-sizing: border-box; padding: 20px; ">  -->
                        ...
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
								...
								<td class="content-cell" 
								 ...
								 <img src="https://api.homeoftraining.com/images/weeklyreport.png" style="width: 100%; height:50%">
								 </td>
								</tr>
								<tr>
                                        ...
                                        <table
                                            ...
                                            <tbody style="font-family: Helvetica, sans-serif; box-sizing: border-box;">
                                                  <tr style="background-color: #444c57;">
                                                            <th
                                                                style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #ffffff; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 10px 5px;text-align: left; font-weight: 600;">
                                                                Company
                                                            </th>
                                                            <th
                                                                style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #ffffff; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 10px 5px;text-align: left; font-weight: 600;">
                                                      ...
                                                      <?php if (count($weekly_data) > 0) { ?>
                                                        @foreach ($weekly_data as $completions)
                                                            <tr class="courses-row">
                                                                <td
                                                                    style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 12px 5px; border-bottom: 1px solid #efefef;">
                                                                    {{ $completions['company_name'] }}
                                                                </td>
                                                                <td
                                                                    style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 12px 5px; border-bottom: 1px solid #efefef;">
                                                                    {{ $completions['first_name'] }}
                                                                </td>
                                                                <td
                                                                    style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 12px 5px; border-bottom: 1px solid #efefef;">
                                                                    {{ $completions['last_name'] }}
                                                                </td>
                                                                <td
                                                                    style="border-collapse: collapse;font-family: Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 12px; width: 90px; word-break: normal; line-height: 15px; padding: 12px 5px; border-bottom: 1px solid #efefef;">
                                                                    {{ $completions['address'] }}
