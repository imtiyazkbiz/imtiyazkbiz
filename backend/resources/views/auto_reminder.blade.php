                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        @if ($company_name == 'individual')
                                            @if ($reminder != '1 day')
                                                <p
                                                    ...
                                                    following
                                                    {{ env('SITE_NAME') }} course(s):
                                                </p>
                                            @else

                                                URGENT REMINDER.
                                                As of today, <b>you have 1 day left</b> to complete the following
                                                course(s):
                                            @endif
                                        @else
                                            @if ($reminder != '1 day')
                                        ...
                                        @foreach ($courses as $course)
                                            <p
                                                style="font-family: Helvetica, sans-serif; box-sizing: border-box; color: #000; font-size: 15px; line-height: 1.5em; margin-top: 4px; text-align: left; text-transform: uppercase; font-weight: 600;">
                                                {{ ucwords($course['name']) }}
                                            </p>
                                        @endforeach
                                        <p
                                            ...
                                            @if ($reminder != '1 day')
                                                ...
                                                As of today you have {{ $reminder }} days to complete the course(s).
                                                Please <a href="{{ env('LMS_URL') . '/#/login' }}"
                                                    style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;">click
                                                    here </a> to login to your account and complete the
                                                course(s) before
                                                {{ $expire_date }}.
                                                If you have forgotten your username and/or password, please <a
                                                    style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;"
                                                    href="{{ env('LMS_URL') . '/#/forget_password' }}">click
                                                    here</a>
                                                and a reminder email will be sent to you. Please contact your employer
                                                or email us at <a
                                                    style="font-family: Helvetica, sans-serif; box-sizing:border-box; color: #3869d4;"
                                                    target="_blank"
                                            ...
                                            @else
                                                ...
                                                course(s) before
                                                {{ $expire_date }}.
                                                If you have forgotten your username and/or password, please
