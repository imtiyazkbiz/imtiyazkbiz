  ...
  >
    ...
    >
      <template v-if="addLink">
        <span class="nav-link-text" :name="link.name">
          {{ link.name }} <b class="caret"></b>
        </span>
      </template>
      <template v-else>
        <i :class="link.icon"></i>
        <span class="nav-link-text" :name="link.name">{{ link.name }} <b class="caret"></b></span>
      </template>
    </a>
    ...
    >
      ...
      >
        <template v-if="addLink">
          <span class="nav-link-text" :name="link.name">{{ link.name }}</span>
        </template>
        <template v-else>
          <i :class="link.icon"></i>
          <span class="nav-link-text" :name="link.name">{{ link.name }}</span>
